...
public final class ConsumerConfigRocket extends RocketMQConfig {
    ...
    public static class ConsumerConfigBuilder {
        ...
        private final ConsumerConfigRocket consumerConfig = new ConsumerConfigRocket();
        ...
        public ConsumerConfigRocket build() {
